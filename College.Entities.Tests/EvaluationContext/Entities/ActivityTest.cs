...
namespace College.Entities.Tests.EvaluationContext.Entities
{
    ...
    public class ActivityTest
    {
        ...
        public void Init()
        {
            activity = new Activity(Guid.NewGuid(), new Student(Guid.NewGuid()), (decimal)2.2, (decimal)10.0);
        }
        [TestMethod]
        ...
        {
            activity = new Activity(Guid.NewGuid(), new Student(Guid.NewGuid()), (decimal)10.2, (decimal)10.0);
